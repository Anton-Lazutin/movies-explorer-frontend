        ...
        <div className="aboutMe__container">
          <div className="aboutMe__text-container">
            ...
            <p className="aboutMe__description">
              я родился в москве в 70ом на краю города моча рано ударила в
              голову в 4 активно ругался матом в детском саду девочки впервые
              показали мне пизду потом школа вонючая форма драки клей так я
              становился сильней воровал деньги в раздевалке в 8 начал курить в
              11 кинул первую палку забил на родителей стал пропадать с друзьями на свалке
            </p>
            <a
